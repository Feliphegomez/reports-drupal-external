	...
	<body>
		...
		<div class="container">
			<div class="blog-header">
				<h1 class="blog-title">Visitas de paginas</h1>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="blog-post">
						<?php
							$sql = "select N.nid, N.title, C.totalcount, C.daycount from ".DB_PREFIX."node AS N INNER JOIN ".DB_PREFIX."node_counter As C where N.nid = C.nid AND C.nid = N.nid group by N.nid ORDER BY C.totalcount DESC";
						...
						<table class="table table-responsive">
							...
							<tbody>
								...
								<tr class="">
									...
									<td>
										<a href="<?php echo $folder_patch_cliente; ?>views-details.html?node=<?php echo $nodo->nid; ?>">
											<?php echo $nodo->title; ?>
										</a>
									</td>
